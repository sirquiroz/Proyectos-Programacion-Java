...
public class frmEjemplo extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       //El hilo me sirve para crear un proceso adicional al que se carga el proceso de la ventana
       Thread miHilo = new Thread(){
           public void run(){
               //el codigo que se ejecuat cuando se inicia el hilo
               try {
                   for (int i = 0; i < 10; i++) {
                       jLabel1.setText(i+"");
                       sleep(2000);//pongo una pausa en la ejecucion del hilo de 2 segundos, lo pongo para ver el efecto del contador
